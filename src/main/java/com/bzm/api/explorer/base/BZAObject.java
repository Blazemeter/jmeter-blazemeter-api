...
package com.bzm.api.explorer.base;
...
public class BZAObject {
    ...
    public static String encode(org.slf4j.Logger logger, String text) {
        return encode(logger, text, UTF_8);
    }

    public static String encode(org.slf4j.Logger logger, String text, String encoding) {
        try {
